...
<body>
	...
	<form id="registrationForm" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>" enctype="multipart/form-data">
		...
		<div class="form-group" id="cvUploadSection" style="display: none;">
			...
			<button id="email_btn">
				<a style="text-decoration: none; color: white;" href="https://mail.google.com/mail/?view=cm&fs=1&to=lenoxrandy@gmail.com&su=Application%20for%20Nutritionist/Trainer&body=Please%20find%20attached%20my%20CV%20and%20photo.%0D%0A%0D%0A%0D%0A--%0D%0ABest%20regards%2C%0D%0A[Your%20Name]" target="_blank">
