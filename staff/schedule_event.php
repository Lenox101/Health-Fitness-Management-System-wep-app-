...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO events (trainer_id, trainer_type, event_name, event_date, event_link) VALUES ('$trainer_id', '$trainer_type', '$event_name', '$event_date', '$event_link')";
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            while ($member = mysqli_fetch_assoc($result)) {
                ...
                try {
                    ...
                    $mail->Body = "Hello $firstName,<br><br>You have been invited to the following event:<br><br>Event Name: $event_name<br>Date: $event_date<br>Link: <a href=\"$event_link\">Join Here</a><br><br>Best Regards,<br>$trainer_first_name $trainer_last_name";
