...
<head>
	...
	<title>Aerobics Instructors</title>
...
<body>
	...
	<div class="container">
		<div class="instructors">
			<h1 style="padding-left:480px; color:aliceblue;">Aerobics Instructors</h1>
			<form action="aerobicsinstructors.php" method="post">
				<div id="citySection">
					<h2>Select City:</h2>
			...
			<div class="box-container" id="instructorBoxContainer">
				...
				if ($_SERVER["REQUEST_METHOD"] == "POST") {
					...
					$sql = "SELECT * FROM `trainers_tbl` WHERE city = '$city' AND status='Approved' AND trainer_type = 'aerobics'";
				...
				<?php
						...
						echo "<script>window.location='aerobicsinstructors.php';</script>";
					}
				}
				?>
			</div>
			<div id="formContainer" style="display: none;">
				<form action="/insert_applications/aerobics_requests.php" method="post">
					<br>
					<h2>Payment Form</h2>
