...
<head>
	...
	<title>Personal Trainer Instructors</title>
	...
	<style>
		...
		body {
			...
			color: #333;
			display: flex;
			background-image: url(/pictures/apply_personal_trainer.jpg);
...
<body>
	...
	<div class="container">
		<div class="instructors">
			<h1 style="padding-left:465px; color:aliceblue;">Personal Instructors</h1>
			<form action="personaltrainerinstructors.php" method="post">
				<div id="citySection">
					<h2>Select City:</h2>
			...
			<div class="box-container" id="instructorBoxContainer">
				...
				if ($_SERVER["REQUEST_METHOD"] == "POST") {
					...
					$sql = "SELECT * FROM `trainers_tbl` WHERE city = '$city' AND status = 'Approved' AND trainer_type = 'personal_trainer'";
				...
				<?php
						...
						echo "<script>alert('There are no Personal Trainers in this Area')</script>";
						echo "<script>window.location='personaltrainerinstructors.php';</script>";
					}
				}
				?>
			</div>
			...
			<div id="formContainer" style="display: none;">
				<form action="/insert_applications/personal_trainer_requests.php" method="post" enctype="multipart/form-data">
					<br>
					<h2>Payment Form</h2>
					...
					<input type="number" name="contact" class="formInput" placeholder="Enter Registered Phone Number" required>
