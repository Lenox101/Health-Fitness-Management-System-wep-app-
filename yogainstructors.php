...
<body>
	...
	<div class="container">
		<div class="instructors">
			<h1 style="padding-left:500px; color:aliceblue;">Yoga Instructors</h1>
			<form action="yogainstructors.php" method="post">
				<div id="citySection">
					<h2>Select City:</h2>
			...
			<div class="box-container" id="instructorBoxContainer">
				...
				if ($_SERVER["REQUEST_METHOD"] == "POST") {
					...
					$sql = "SELECT * FROM `trainers_tbl` WHERE city = '$city' AND status = 'Approved' AND  trainer_type = 'yoga'";
				...
				<?php
						...
						echo "<script>window.location='yogainstructors.php';</script>";
					}
				}
				?>
			</div>
			...
			<div id="formContainer" style="display: none;">
				<form action="/insert_applications/yoga_requests.php" method="post">
					<br>
					<h2>Payment Form</h2>
					...
					<input type="number" name="contact" class="formInput" placeholder="Enter Your Registered Phone Number" required>
